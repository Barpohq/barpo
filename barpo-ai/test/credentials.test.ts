...
import { FileCredentialStore, MemoryCredentialStore } from '../src/credentials.ts'
...
describe('FileCredentialStore', () => {
  test('mavjud bo\'lmagan fayl — bo\'sh ombor', async () => {
    const o = new FileCredentialStore(yol)
  ...
  test('yozilgan kredensial qayta o\'qiladi', async () => {
    ...
    const boshqa = new FileCredentialStore(yol)
...
describe('MemoryCredentialStore', () => {
  test('asosiy amallar ishlaydi', async () => {
    const o = new MemoryCredentialStore()
