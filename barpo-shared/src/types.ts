...
// (It used to live inside barpo-ui/src/data/mock.ts; now mock.ts imports
...
// barpo-server/src/skill-store.ts.
...
//
// Three things follow from that (barpo-ai/src/mcp-*.ts):
...
export interface AppState {
   ...
   * │ point is `barpo-server/src/state-run.ts` → `validateCode()`.  │
   * └──────────────────────────────────────────────────────────────────┘
   */
  code: string
  /**
 ...
 * │ `barpo-server/src/action-run.ts` → `validateCode()`.              │
 * └──────────────────────────────────────────────────────────────────────┘
 */
